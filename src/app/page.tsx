...
export default function Home() {
  ...
  const stats = [
    { label: "Usuarios Activos", value: onlineUsers.length.toString(), icon: <Users className="h-4 w-4" /> },
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600">Cargando Misión Maestra...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="space-y-4">
              ...
              {user && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto mt-8">
                  ...
                  <Card>
                    <CardContent className="pt-6">
                      <div className="text-2xl font-bold text-green-600">{user.totalXP}</div>
                      <div className="text-sm text-gray-600">XP Total</div>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="pt-6">
                      <div className="text-2xl font-bold text-red-600">{user.socialBattery}%</div>
